// src/pages/cv/templates/modern/ModernTemplate1.jsx
import React from 'react';
import EditableField from '../../components/EditableField';

const ModernTemplate1 = ({ data, onUpdate }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden print:shadow-none">
      <div className="p-8 md:p-10">
        ...
        {/* Tiểu sử chuyên môn */}
        <div className="mb-6">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-400 mb-3">TIỂU SỬ CHUYÊN MÔN</h2>
          <EditableField
            value={data.personalInfo?.summary}
            onSave={(v) => updateField('personalInfo.summary', v)}
            placeholder="Tôi là một nhà thiết kế đồ họa và họa sĩ minh họa 26 tuổi, tập trung vào xây dựng thương hiệu, kiểu chữ và thiết kế bố cục..."
            multiline
            className="text-gray-600 leading-relaxed"
          />
        </div>

        {/* Kỹ năng chính + Thông tin liên hệ - 2 cột */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
          {/* Kỹ năng chính */}
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wider text-gray-400 mb-3">KỸ NĂNG CHÍNH</h2>
            ...
            <div className="space-y-1 text-sm text-gray-600">
              <div>
                <EditableField
                  ...
                  placeholder="Điện thoại: 0912 3456 7890"
                />
              </div>
              <div>
                <EditableField
                  ...
                  placeholder="Email: xinchao@trangwebhay.com"
                />
              </div>
              <div>
                <EditableField
                  ...
                  placeholder="Địa chỉ: Hà Nội, Việt Nam"
                />
              </div>
              <div>
                <EditableField
                  ...
                  placeholder="Website: www.trangwebhay.com"
                />
              </div>
            </div>
          </div>
